...
/**
 * Created by jacob_000 on 1/5/2015.
 */
...
public class WearableListItemLayout extends LinearLayout implements
    ...
    public WearableListItemLayout(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        mFadedCircleColor = getResources().getColor(R.color.blue);
        mChosenCircleColor = getResources().getColor(R.color.white);
    }
    ...
    protected void onFinishInflate() {
        ...
        mName = (TextView) findViewById(R.id.list_text);
    }
